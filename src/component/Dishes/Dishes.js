...
const Dishes = ({ dishesImg, dishesName, dishesPrice, bowls }) => {
	return (
		<div className="dishes">
			<div className="dishes-img">
				<img src={dishesImg} alt="dishesImg" />
			</div>

			<span className="dishes-name">{dishesName}</span>
			<div className="dishes-item">
				<span className="dishes-item-price">{dishesPrice}</span>
				<span className="dishes-item-bowls">{bowls}</span>
			</div>

			<button className="dishes-edit">
				<span>
